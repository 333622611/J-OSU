...
public class Osu extends Canvas implements Runnable {
    ...
    private Song song;
    private MP3Player mainTheme;
    private final Status status;
    private final End end;
    private final Pause pause;
    private final Player player;
    private final Splasherino splasherino;
    private State state;
    ...
    private double ticksPerSec = 200.0;
    ...
    public Osu() throws Exception {
        ...
        splasherino = new Splasherino(menu, player, status, sprites);
