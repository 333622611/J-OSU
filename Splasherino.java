...
public class Splasherino {
    ...
    public Splasherino(Menu menu, Player player, Status status, Sprites sprites) {
        this.menu = menu;
        this.player = player;
        this.status = status;
        ...
        try {
            ...
            Logger.getLogger(Splasherino.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
